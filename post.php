...
<body>
    <header class="header">
        ...
        <ul class="listline">
            ...
            <li class="listitem"><a class="navigation1" href="#">About</a></li>
            <li class="listitem"><a class="navigation1" href="#">Contact</a></li>
        </ul>
    </header>
    ...
    <footer class="footer">
        ...
        <ul class="listline">
            ...
            <li class="listitem"><a class="navigation2" href="#">About</a></li>
            <li class="listitem"><a class="navigation2" href="#">Contact</a></li>
        </ul>
    </footer>
</body>
